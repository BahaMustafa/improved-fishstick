...
import './Services.css';
import { FaTools, FaBath, FaLayerGroup, FaCogs } from 'react-icons/fa';

function Service({ title, children, className, icon }) {
...
function Services() {
  return (
    <section id="services">
      <h2>Our Services</h2>
      <Service title="Kitchen Remodeling" className="kitchen-remodeling" icon={<FaTools />}>
      ...
      <Service title="Bathroom Remodeling" className="bathroom-remodeling" icon={<FaBath />}>
      ...
      <Service title="Flooring Solutions" className="flooring-solutions" icon={<FaLayerGroup />}>
      ...
      <Service title="Concrete Slab Construction" className="concrete-slab-construction" icon={<FaCogs />}>
